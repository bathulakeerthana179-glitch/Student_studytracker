...
SECRET_KEY = 'django-insecure-+ox-uydhb)cgs^3jsii*x0w$z(g=p3=39-%vbrwa$!b+bg&y#f'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'studytrackerai@gmail.com'
EMAIL_HOST_PASSWORD = 'zvbmcdmoccwbtcty'
